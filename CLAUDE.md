...
- Comments, docs and commit messages: brief, neutral, project-specific.
  No references to other projects, and nothing about compiler internals —
  not how it optimizes, which build of it was used, or how two of them
  compare. This repo is public. Measure with whatever is installed and
  write down what changed *here*; findings about the compiler belong
  wherever that compiler is developed, not in this tree.
